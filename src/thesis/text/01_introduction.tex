...
Their study has contributed to numerous major scientific discoveries, including the calculation of the rate of at which the universe expands. \parencite{Hubble1929} In addition, the analysis of variable stars can support the detection of extraterrestrial planets.

Recent technological progress has led to substantial improvements in photometric instrumentation, enabling the development of large-scale astronomical surveys such as \textbf{OGLE} (Optical Gravitational Lensing Experiment) \parencite{Udalski2008}, the \textbf{Kepler} planet-detection mission \parencite{Borucki2010}, the \textbf{Zwicky} Transient Facility survey \parencite{Bellm2019}, and \textbf{TESS} (Transiting Exoplanet Survey Satellite) \parencite{Ricker2014}.
