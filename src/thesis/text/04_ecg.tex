...
\begin{table}[H]
    ...
    \caption[MIT-BIH Class distribution]{Class distribution of the MIT-BIH dataset.}
...
\begin{figure}[!htbp]
    ...
    \caption[MIT-BIH Examples]{Examples of each class in the MIT-BIH dataset.}
...
\begin{table}[H]
    ...
    \caption[Base Transformer Training Parameters]{Base Transformer Training Parameters.}
...
\begin{figure}[!htbp]
    ...
    \caption[Base Transformer Training Curves]{Base Transformer Training Curves.}
...
\begin{table}[H]
    ...
    \caption[Base Transformer Evaluation Metrics]{Base Transformer Evaluation Metrics.}
...
\begin{figure}[!htbp]
    ...
    \caption[Base Transformer Confusion Matrix]{Base Transformer Confusion Matrix.}
...
\subsection{Qwen 2.5 0.5B fine-tune}

For the next experiment we've performed a LoRA fine-tune of pretrained a Qwen 2.5 0.5B\footnote{\url{https://huggingface.co/Qwen/Qwen2.5-0.5B}} LLM\@. \parencite{qwen2025}
The size of 0.5B (500 million parameters) made it small enough to effectively fine-tune on the available hardware (AMD Radeon RX 9070 GPU).
...
\begin{table}[H]
    ...
    \caption[Qwen 2.5 0.5B Configuration]{Qwen 2.5 0.5B Configuration.}
...
\begin{table}[H]
    ...
    \caption[Qwen 2.5 0.5B Training Parameters]{Qwen 2.5 0.5B Training Parameters.}
...
\begin{figure}[!htbp]
    ...
    \caption[Qwen 2.5 0.5B Training Metrics]{Qwen 2.5 0.5B Training Metrics.}
...
\begin{table}[H]
    ...
    \caption[Qwen 2.5 0.5B Evaluation Metrics]{Qwen 2.5 0.5B Evaluation Metrics.}
...
\begin{figure}[!htbp]
    ...
    \caption[Qwen 2.5 0.5B Confusion Matrix]{Qwen 2.5 0.5B Confusion Matrix.}
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{Xcccc}
        ...
        \bottomrule
    \end{tabularx}
    \caption[Comparison of Results]{Comparison of different models by various authors, ordered by Macro F1 Score.}
