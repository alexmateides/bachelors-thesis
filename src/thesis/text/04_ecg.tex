...
Previous work by \parencite{Hu2022, ECGformer} was used as the basis for the used hyperparameters.
...
For the next experiment we've performed a LoRA fine-tune of pretrained a Qwen2.5 0.5B\footnote{https://huggingface.co/Qwen/Qwen2.5-0.5B} LLM\@.
