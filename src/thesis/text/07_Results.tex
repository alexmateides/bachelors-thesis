...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X c@{\hspace{3em}}c@{\hspace{3em}}c}
        ...
        \bottomrule
    \end{tabularx}
    \caption[Experiment]{Summary of the conducted experiments.}
...
Because of the low gap between the baseline CNN and the evaluated models that had access to the same information (all 6 channels enabled), we theorize that the majority of the performance was decided by the multi-channel architecture and light curve segmentation.
