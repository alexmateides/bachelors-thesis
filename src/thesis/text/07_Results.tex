...
As can be seen from \hyperref[tab:06_experiment_summary]{Table 6.21}, the Chronos-2 fine-tunes dominated both tasks, significantly outperforming the other models and was the only model that significantly outperformed the baseline CNN on both tasks.

Because of the low gap between the baseline CNN and the evaluated models, we theorize that the majority of the performance was decided by the multi-channel architecture and light curve segmentation.
