...
Navržený přístup je dále porovnán s jednoduchým baseline modelem a s klasifikacemi dostupnými v publikovaných astronomických katalozích.
...
Multiple experiments are carried out using different model configurations and hyperparameter settings, and the resulting performance is assessed with standard multi-class classification metrics. The proposed approach is further compared with a simple baseline model and with classifications available in published astronomical catalogues.
...
%%%%%%%%%%%%%%%%%%%
    \begin{acknowledgmentpage}
        I am also grateful to my thesis advisor, RNDr.\,Petr Škoda,\,CSc., for his wise counsel, helpful recommendations and continuous support throughout my journey.
        Additionally, I would like to thank Mgr.\,Marek Skarka\,Ph.D. for generously providing the light curve datasets used in this thesis and for his insightful comments regarding the classification of variable stars.
...
%%%%%%%%%%%%%%%%%%%
    ...
    \include{text/01_introduction} % include `text.tex' from `text/' subdirectory
    \include{text/02_astronomical_background}
    \include{text/03_overview_of_technologies}
    \include{text/04_ecg}
    \include{text/05_tess_light_curve_dataset}
    \include{text/06_light_curve_classifiers}
    \include{text/07_Discussion}
